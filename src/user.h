...
#define DEFAULT_USER "UnknownUser0"
#define SUPER_USER   "Root"

#define PLAN_SIZE    10 /* Nb lines for the .plan (won't work for more than 10 plans)*/
...
extern int    IsUpperEqUser      (const user *User1, const user *User2);
