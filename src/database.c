...
int ReadDataBase(void) {
   ...
   FILE   *DataBase;
   char    Line[512], *UserName, *GroupName, *Password, *Name, *EMail, *Formation, *LeaderName, *Symbol, *AliasName, *Command, *Plan, *LastLoginHost, *LastFailHost;
   ...
   while (fgets(Line,512,DataBase) != NULL) {
